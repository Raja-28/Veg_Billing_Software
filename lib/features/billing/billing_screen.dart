...
class _SaveBillButtonState extends State<_SaveBillButton> {
  ...
  Future<void> _save(BuildContext context) async {
    // Save farmer name before clearing state
    final farmerName = widget.billState.selectedFarmer?.name ?? 'Unknown';
      ...
      if (mounted) {
        displayInfoBar(context, builder: (context, close) {
          return InfoBar(
            ...
            content: Text('Bill for $farmerName saved successfully.'),
