...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final totalStockAsync = ref.watch(totalStockQuantityProvider);
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: outstandingBalanceAsync.when(
                          data: (balance) {
                            final balanceInRupees = (balance / 100).toStringAsFixed(2);
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, size: 28, color: color ?? Colors.grey[100]),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: Column(
